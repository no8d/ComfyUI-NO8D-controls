...
const TEXT = {
    en: {
        ...
        featherRange: "Feather range",
        maskOpacity: "Opacity",
        maskColorLabel: "Color",
        growMaskBy: "Grow mask",
        brushSize: "Brush size",
        resetEdit: "Reset current edit",
        canvasRatio: "Ratio",
        swapCanvas: "Swap",
        ratioSwap: "Ratio swap",
        imageHistory: "Image history",
        historyImage: "History image {index}",
        autoOutput: "Auto output downstream",
        outputCurrentImage: "Output current image",
        outputCurrentImageFailed: "Failed to output the current image",
        sliderStackTitle: "NO8D-LoRA stack",
        generateTitle: "NO8D-Generate",
        removeKreaReferenceTitle: "NO8D-Remove Krea2 Reference Latents",
        removeKreaReferenceDescription: "Remove Ostris Krea2 reference latents while preserving the remaining conditioning metadata.",
        abPreviewTitle: "NO8D-A/B preview",
        abAutoOutput: "Auto output image A",
        addLora: "Add LoRA",
        ...
        visionModelHint: "Used for image-only and text-plus-image prompting. Instruct variants are usually faster and more stable than Thinking variants for spatial analysis.",
        ...
        apiValidationWarning: "API connected, but the selected model is unavailable",
        ...
        imageLoaderPasteHint: "Click the preview, then press Ctrl+V to paste images",
        imageLoaderOpenOriginal: "Double-click to open the original image",
        ...
        imageGridTitle: "NO8D-Image Grid",
        imageGridDescription: "Combine multiple images horizontally, vertically, or in a grid using the first image as the size reference.",
        imageComposerTitle: "NO8D-Image Composer",
        imageComposerDescription: "Build a layered composition in a freeform canvas editor.",
        imageComposerImage: "image",
        imageComposerWidth: "width",
        imageComposerHeight: "height",
        imageGridLayout: "Layout",
        imageGridCropMode: "Crop mode",
        imageGridColumns: "Grid columns (0 = auto)",
        imageGridSpacing: "Margin / spacing",
        imageGridBackground: "Background color",
        imageGridHorizontal: "Horizontal",
        imageGridVertical: "Vertical",
        imageGridGrid: "Grid",
        imageGridCropNone: "None",
        imageGridCropStandard: "Standard crop",
        imageGridCropLeft: "Left crop",
        imageGridCropCenter: "Center crop",
        imageGridCropRight: "Right crop",
        imageTitleTitle: "NO8D-Image Title",
        kreaStyleTitle: "NO8D-Prompt-libraries",
        kreaStyleDescription: "Browse, manage, and combine reusable prompt libraries visually.",
        imageTitleDescription: "Add a title bar outside the top or bottom edge, or overlay a title inside the image.",
        imageTitleImages: "Image",
        imageTitleTitles: "Titles (one per line)",
        imageTitleOutputSize: "Image size",
        imageTitleOriginalSize: "Original size",
        imageTitle1K: "1K",
        imageTitle2K: "2K",
        imageTitle4K: "4K",
        imageTitleBarColor: "Title background",
        imageTitleBarOpacity: "Background opacity",
        imageTitlePosition: "Title position",
        imageTitleBarHeight: "Title bar height",
        imageTitleFontSize: "Title font size",
        imageTitlePadding: "Title padding",
        imageTitleTextColor: "Title color",
        imageTitleTextAlign: "Title alignment",
        imageTitleOutsideTop: "Outside top",
        imageTitleInsideTop: "Inside top",
        imageTitleMiddle: "Middle",
        imageTitleInsideBottom: "Inside bottom",
        imageTitleOutsideBottom: "Outside bottom",
        imageTitleAlignLeft: "Left",
        imageTitleAlignCenter: "Center",
        imageTitleAlignRight: "Right",
        saveTitle: "NO8D save",
        noImage: "No image",
    },
    zh: {
        ...
        ratioSwap: "比例对调",
        imageHistory: "图像历史",
        historyImage: "历史图像 {index}",
        autoOutput: "自动输出到下游",
        outputCurrentImage: "输出当前图像",
        outputCurrentImageFailed: "当前图像输出失败",
        sliderStackTitle: "NO8D-LoRA 堆栈",
        generateTitle: "NO8D-生成",
        removeKreaReferenceTitle: "NO8D-移除 Krea2 参考 Latents",
        removeKreaReferenceDescription: "移除 Ostris Krea2 参考 latents，同时保留其余 conditioning 元数据。",
        abPreviewTitle: "NO8D-A/B 对比",
        abAutoOutput: "自动输出图像 A",
        addLora: "添加 LoRA",
        invertEnabled: "反选",
        ...
        textModel: "文本模型",
        visionModel: "图像模型",
        visionModelHint: "用于纯图像和文本+图像提示词。进行空间分析时，Instruct 版本通常比 Thinking 版本更快、更稳定。",
        noModelsConfigured: "尚未选择模型。请先验证 API，然后在下拉菜单中选择一个模型。",
        selectedModel: "已选模型",
        apiValidated: "API 验证通过",
        apiValidationWarning: "API 已连接，但所选模型不可用",
        ...
        imageLoaderPasteHint: "点击预览区后按 Ctrl+V 粘贴图像",
        imageLoaderOpenOriginal: "双击打开原图",
        ...
        imageGridTitle: "NO8D-多图拼接",
        imageGridDescription: "按第一张图的尺寸基准，将多张图片横向、纵向或网格拼接。",
        imageComposerTitle: "NO8D-图层合成器",
        imageComposerDescription: "在自由画布编辑器中导入、排列并合成多个图片图层。",
        imageComposerImage: "图片",
        imageComposerWidth: "宽度",
        imageComposerHeight: "高度",
        imageGridLayout: "拼接方式",
        imageGridCropMode: "裁切方式",
        imageGridColumns: "网格列数（0=自动）",
        imageGridSpacing: "边距 / 间距",
        imageGridBackground: "背景颜色",
        imageGridHorizontal: "横向",
        imageGridVertical: "纵向",
        imageGridGrid: "网格",
        imageGridCropNone: "none",
        imageGridCropStandard: "标准裁切",
        imageGridCropLeft: "居左裁切",
        imageGridCropCenter: "居中裁切",
        imageGridCropRight: "居右裁切",
        imageTitleTitle: "NO8D-图片标题",
        kreaStyleTitle: "NO8D-Prompt-libraries",
        kreaStyleDescription: "通过可视化界面浏览、管理和组合可复用提示词库。",
        imageTitleDescription: "在图片顶部或底部添加标题栏，或在图片中间叠加标题。",
        imageTitleImages: "图片",
        imageTitleTitles: "独立标题（每行一个）",
        imageTitleOutputSize: "图像尺寸",
        imageTitleOriginalSize: "原始尺寸",
        imageTitle1K: "1K",
        imageTitle2K: "2K",
        imageTitle4K: "4K",
        imageTitleBarColor: "标题底色",
        imageTitleBarOpacity: "底色透明度",
        imageTitlePosition: "标题位置",
        imageTitleBarHeight: "标题色条高度",
        imageTitleFontSize: "标题字号",
        imageTitlePadding: "标题间距",
        imageTitleTextColor: "标题颜色",
        imageTitleTextAlign: "标题对齐",
        imageTitleOutsideTop: "图外顶部",
        imageTitleInsideTop: "图内顶部",
        imageTitleMiddle: "中部",
        imageTitleInsideBottom: "图内底部",
        imageTitleOutsideBottom: "图外底部",
        imageTitleAlignLeft: "居左",
        imageTitleAlignCenter: "居中",
        imageTitleAlignRight: "居右",
        saveTitle: "NO8D-图文保存",
        noImage: "没有图像",
    },
};
