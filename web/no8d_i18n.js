...
const TEXT = {
    en: {
        ...
        kreaStyleTitle: "NO8D-Krea2 Style Selector",
        kreaStyleDescription: "Choose a Krea 2 style from four categories and output its complete English style prompt.",
    ...
    zh: {
        ...
        kreaStyleTitle: "NO8D-Krea2风格选择",
        kreaStyleDescription: "从四个大分类中选择 Krea 2 风格，并输出对应的完整英文风格提示词。",
