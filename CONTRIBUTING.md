...
Thanks for helping improve ComfyUI-NO8D-control.

## Before opening a pull request

1. Keep node responsibilities separate: Stack owns LoRA loading, Inpainting owns sampling and masks, and A/B preview owns comparison.
...
```powershell
python -m py_compile __init__.py compare_slider_preview.py slider_lora_lite.py slider_lora_stack.py
node --check web/no8d_comfy_events.js
node --check web/no8d_i18n.js
node --check web/compare_slider_preview.js
node --check web/slider_lora_lite.js
